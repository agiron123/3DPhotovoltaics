class GraphSettings(object):
    ...
    def __init__(self, settingsDict):
        ...
        self.AverageReflectionsVsAzimuthal = settingsDict["AverageReflectionsVsAzumithal"]
        self.AbsorptionEfficiencyVsAzimuthal = settingsDict["AbsorptionEfficiencyVsAzumithal"]

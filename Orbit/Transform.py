...
class Transform(object):
    ...
    def __init__(self, M,):
        ...
        @type M: 2D array of numbers
        @param M: The 2D array to use when defining the transformation
        """
    ...
    def transform(self, v):
        ...
        @type v: Numpy array whose dimensions make sense given the transformation
